...
extension Bundle {
    static func myResourceBundle() -> Bundle? {
        ...
        let bundlePaths = bundles.compactMap { $0.resourceURL?.appendingPathComponent("ImagePicker_ImagePicker", isDirectory: false).appendingPathExtension("bundle") }
...
open class AssetManager {
    ...
    public static func getImage(_ name: String) -> UIImage {
        ...
        if let resource = bundle?.resourcePath, let resourceBundle = Bundle(path: resource + "/ImagePicker_ImagePicker.bundle") {
